Shader "Custom/LineParticle"
{
	...
	Properties
	{
		...
		d0 ("Pallet 0", Color) = (1, 1, 1, 1)
		d1 ("Pallet 1", Color) = (1, 1, 1, 1)
		d2 ("Pallet 2", Color) = (1, 1, 1, 1)
		d3 ("Pallet 3", Color) = (1, 1, 1, 1)
		d4 ("Pallet 4", Color) = (1, 1, 1, 1)
		d5 ("Pallet 5", Color) = (1, 1, 1, 1)
		d6 ("Pallet 6", Color) = (1, 1, 1, 1)
		d7 ("Pallet 7", Color) = (1, 1, 1, 1)
	}
