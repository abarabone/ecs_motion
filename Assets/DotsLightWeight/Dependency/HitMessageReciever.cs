...
namespace DotsLite.Dependency
{
        ...
        public static partial class HitMessage<THitMessage>
    {
        ...
        /// <summary>
        /// �q�b�g�������肩��̃��b�Z�[�W��󂯎��A���߂Ă����B
        /// ���b�Z�[�W�́AIHitMessageApplyJobExecution<THitMessage> �W���u�ŏ�������B
        /// �q�b�g���o���V�X�e���ɂ� ParallelWriter ��n���āA��������ł�炤�B
        /// </summary>
        ...
        //public partial struct Reciever : IDisposable
        {
            ...
            Allocator holderAllocator;// �b��Adispose �p
        ...
        //public partial struct Reciever
        {
            ...
            /// <summary>
            /// �n�b�V���}�b�v�ł܂Ƃ�ȏ��񂪂ł���悤�ɂȂ�܂ł̂Ȃ��B
            /// native list �Ƀ��j�[�N�� entity ��o�^���A�L�[�Ƃ��ď��񂷂�B
            /// </summary>
