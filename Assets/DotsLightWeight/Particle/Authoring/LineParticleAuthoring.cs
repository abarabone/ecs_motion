...
namespace DotsLite.Authoring
{
    ...
    public class LineParticleAuthoring : MonoBehaviour//DrawPrefabSettingsAuthoring.ConvertToMainCustomPrefabEntityBehaviour
    {
        ...
        /// 
        /// </summary>
        /// <param name="isHalfEdge">ê^Ç»ÇÁÇyå^ÅAãUÇ»ÇÁÉGå^ÇÃÉÅÉbÉVÉÖÇê∂ê¨Ç∑ÇÈÅB</param>
