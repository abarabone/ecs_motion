...
namespace Abarabone.Structure
{
    ...
    public class StructureHitMessageApplySystem_ : CommandSystemBase<BeginInitializationEntityCommandBufferSystem>
    {
        ...
        {
            base.OnCreate();
            this.Reciever = new HitMessageReciever<StructureHitMessage, JobExecution>(10000, maxDependsSystem: 32);
        }
        ...
        protected override void OnUpdateWith(EntityCommandBuffer commandBuffer)
        {
            ...
            this.Dependency = this.Reciever.Schedule(this.Dependency, exec);
        }
