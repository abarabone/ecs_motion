...
namespace Abarabone.Structure.Authoring
{
    ...
    [UpdateAfter(typeof(LateBuildCompoundColliderSystem))]
    public class LateRemoveStructurePartEntitiesSystem : GameObjectConversionSystem
    {
        ...
        protected override void OnUpdate()
        {
            ...
            //(
            //    (Entity e, StructureBuildingModelAuthoring.StructPartRemoveLateTag c) =>
            //    {
