...
namespace DotsLite.Structure.Authoring
{
    ...
    public class StructureAreaEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            //        .OfType<StructureAreaAuthoring>()
            //        .SelectMany(st => st.GetComponentsInChildren<StructureAreaPartAuthoring>())
            ...
            //        .Select(x => (x.st, x.Item2?.GetComponent<StructureAreaAuthoring>()));
            ...
            if (GUILayout.Button("disribute part id"))
            {
                var parts = this.targets
                    ...
                    .SelectMany(s => s.GetComponentsInChildren<StructureAreaPartAuthoring>())
                    ;
