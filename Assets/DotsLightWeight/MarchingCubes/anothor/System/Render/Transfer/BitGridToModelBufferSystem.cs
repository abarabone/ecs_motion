...
//            var gridAreas = this.GetComponentDataFromEntity<BitGridArea.LinkToGridData>(isReadOnly: true);
...
//                    NearGridIndex pickupNeargridIds_(BitGridArea.LinkToGridData area, BitGrid.GridIndex index)
//                    {
