...
namespace Abarabone.MarchingCubes
{
    ...
    static class ProcesserUtility2
    {
        ...
        public static unsafe void SampleAlternateCubes2
            (ref this DotGrid32x32x32Unsafe grid, int gridid, uint4 *pDst, uint *pOutput, ref int outputCounter)
        {
            ...
            for (var iy = 0; iy < 31; iy += 1*2)
            {
                for (var iz = 0; iz < 31; iz += 4*2)
                {
                    ...
                    var x9191 = bitwise_x_(cubes._ba32ba32, cubes._98109810);
                    var xb3b3 = bitwise_x_(cubes._dc54dc54, cubes._ba32ba32);
                    var xd5d5 = bitwise_x_(cubes._fe76fe76, cubes._dc54dc54);
                    var xf7f7 = bitwise_xr_(cubes._98109810, cubes._fe76fe76);
