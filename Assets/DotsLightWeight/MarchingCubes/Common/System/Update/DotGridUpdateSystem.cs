...
//            this.Entities
//                .WithAll<DotGrid<DotGrid32x32x32>.ParentAreaData>()
//                .ForEach((
//                    Entity entity,
...
//            this.Entities
//                .WithAll<DotGrid<DotGrid16x16x16>.ParentAreaData>()
//                .ForEach((
//                    Entity entity,
...
//            {
//                dotgrids32 = this.GetComponentDataFromEntity<DotGrid<DotGrid32x32x32>.UnitData>(isReadOnly: true),
//                dotgrids16 = this.GetComponentDataFromEntity<DotGrid<DotGrid16x16x16>.UnitData>(isReadOnly: true),
//                dirties = this.GetComponentDataFromEntity<DotGrid<TGrid>.UpdateDirtyRangeData>(),
...
//        {
//            [ReadOnly]
//            public ComponentDataFromEntity<DotGrid<TGrid>.UnitData> dotgrids32;
//            [ReadOnly]
//            public ComponentDataFromEntity<DotGrid<TGrid>.UnitData> dotgrids16;
//            [ReadOnly]
...
//            public ComponentDataFromEntity<DotGrid<TGrid>.UpdateDirtyRangeData> dirties;
...
//                this.dirties[targetEntity] = new DotGrid<TGrid>.UpdateDirtyRangeData
//                {
//                    begin = 0,//32 * 32 / 2,
//                    end = 32 * 32 - 1,
//                };
